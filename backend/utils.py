...
def setup_sidebar():
    ...
    with st.sidebar:
        ...
        if st.session_state.get("logged_in", False):
            ...
            # 没登录时，侧边栏只有一行提示，不给任何 page_link 按钮！
            st.markdown("<p style='color:#ef4444; font-weight:bold; text-align:center;'>🔒 请先在右上角登录</p>", unsafe_allow_html=True)