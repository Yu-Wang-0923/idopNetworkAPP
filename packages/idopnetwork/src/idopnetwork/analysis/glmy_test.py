...
由页面通过 ``from idopnetwork.analysis.glmy_test import ...`` 引用。
"""
...
DEFAULT_M3_CSV: Path | None = None  # Set by application layer
DEFAULT_DIM: int = 4
...
def main(
    ...
    *,
    ...
    if save_dir is None:
        raise ValueError("save_dir must be provided; no default output directory is set.")
